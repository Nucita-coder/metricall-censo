...
interface SeccionEstadoPagoCobranzaProps {
...
export function SeccionEstadoPagoCobranza({
  estadoPagoActual,
  isSaving,
  onCambiarEstadoPago,
  onAbrirModalRechazo,
}: SeccionEstadoPagoCobranzaProps) {
  const badgeConfig =
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          style={[
            styles.actionBtn,
            estadoPagoActual === 'Pago Procesado' ? styles.btnProcesadoActive : styles.btnProcesadoInactive,
        ...
        <TouchableOpacity
          style={[
            styles.actionBtn,
            estadoPagoActual === 'Pago Rechazado' ? styles.btnRechazadoActive : styles.btnRechazadoInactive,
            isSaving && styles.btnDisabled,
          ]}
