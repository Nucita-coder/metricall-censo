...
import { View, Text, Modal, TouchableOpacity, StyleSheet, Pressable, ScrollView, Platform, TextInput, ActivityIndicator, Image, StyleProp, ViewStyle } from 'react-native';
...
import { styles } from './ModalTableroMenu.styles';
