...
export const COBRANZA_RESULTADO_COLORS: Record<string, ResultadoColorConfig> = {
  ...
  'NO CONTESTO': { bg: 'rgba(100, 116, 139, 0.2)', text: '#94A3B8', border: '#475569', barColor: '#64748B' },
  'PIDE AJUSTE DE PLAN': { bg: 'rgba(139, 92, 246, 0.18)', text: '#A78BFA', border: '#7C3AED', barColor: '#8B5CF6' },

  // ACCIÓN NEGATIVA / CAUSAS NEGATIVAS
  'PIDE RETIRO': { bg: 'rgba(239, 68, 68, 0.2)', text: '#F87171', border: '#DC2626', barColor: '#EF4444' },
  'RECHAZO A PAGAR POR DIAS SIN SERVICIO': { bg: 'rgba(244, 63, 94, 0.2)', text: '#FB7185', border: '#E11D48', barColor: '#F43F5E' },
  'TIENE FALLA': { bg: 'rgba(249, 115, 22, 0.2)', text: '#FB923C', border: '#EA580C', barColor: '#F97316' },
  'INCONFORMIDAD CON MONTO': { bg: 'rgba(217, 70, 239, 0.2)', text: '#E879F9', border: '#C026D3', barColor: '#D946EF' },
  'NO RECONOCE DEUDA': { bg: 'rgba(225, 29, 72, 0.2)', text: '#FDA4AF', border: '#BE123C', barColor: '#E11D48' },
  'REHUSA ENTREGAR EQUIPO': { bg: 'rgba(185, 28, 28, 0.25)', text: '#FCA5A5', border: '#991B1B', barColor: '#B91C1C' },
  'PUERTO LIBERADO': { bg: 'rgba(168, 85, 247, 0.2)', text: '#C084FC', border: '#9333EA', barColor: '#A855F7' },
  'TIENE OTRO SERVICIO': { bg: 'rgba(120, 113, 108, 0.2)', text: '#D6D3D1', border: '#57534E', barColor: '#78716C' },
  'NO DESEA PAGAR': { bg: 'rgba(220, 38, 38, 0.25)', text: '#EF4444', border: '#B91C1C', barColor: '#DC2626' },
};
