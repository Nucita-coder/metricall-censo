-- ============================================================
-- MIGRACIÓN 103: FIX – Eliminar referencia a updated_at en perfiles
-- La columna updated_at NO existe en la tabla perfiles.
-- ============================================================
...
BEGIN
    ...
    -- 5. Desvincular el perfil de la empresa
    --    NOTA: updated_at fue eliminado porque NO existe en la tabla perfiles
